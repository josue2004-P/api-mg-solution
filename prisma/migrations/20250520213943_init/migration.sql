...
CREATE TABLE `BP_01_USUARIO` (
    ...
    `bInactivo` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `BP_04_PERFIL_USUARIO` (
    ...
    INDEX `BP_04_PERFIL_USUARIO_nId01Usuario_fkey`(`nId01Usuario`),
    INDEX `BP_04_PERFIL_USUARIO_nId02Perfil_fkey`(`nId02Perfil`),
...
CREATE TABLE `BP_05_PERFIL_PERMISO` (
    ...
    INDEX `BP_05_PERFIL_PERMISO_nId02Perfil_fkey`(`nId02Perfil`),
    INDEX `BP_05_PERFIL_PERMISO_nId03Permiso_fkey`(`nId03Permiso`),
